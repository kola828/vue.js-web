...
var getUser = (name) => axios({
  method: 'GET',
  url: baseUrl + '/v1/user/' + name
});

//匹配token
var checkToken = (data) => axios({
  method: 'POST',
  url: baseUrl + '/v1/accesstoken',
  data: data
});
...
var addNewReplies = (id, data) => axios({
  method: 'POST',
  url: baseUrl + '/v1/topic/' + id + '/replies',
  data: data
});
/**
 * methods addNewArt
